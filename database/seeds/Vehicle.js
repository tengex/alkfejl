  ...
  * run() {
    ...
    const id = yield Database
      ...
      .insert([
        ...
        { license_plate: "BPO-025", manufacturer: "IKARUS", type: "280", category: "Busz", is_active: false, is_available: false },
        ...
        { license_plate: "CCV-442", manufacturer: "IKARUS", type: "266", category: "Busz", is_active: true, is_available: true },
      ]);
  }
